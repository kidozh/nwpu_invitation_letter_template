...
\address{
	...
	\hspace{0.80\textwidth} % Position of the institution logo, increase to move left, decrease to move right
	\vskip -0.15\textheight~\\ % Position of the large header text in relation to the institution logo, increase to move down, decrease to move up
